...
<html lang="en-US">
    <head>
		...
		<title><?php echo $servis["name"]; ?> - Show Market Web Site</title>
		...
		<div class="row">
			<div class="col-md-12 txtc  text-center ccase">
				...
				<div class="breadcumb-inner">
					<ul>
						<li><a href="index.php">Show Market</a></li>
			...
			<div class="col-lg-6 col-md-12 col-sm-12">
				<div class="single_image_area">
					<div class="single_image  ">
						<img src="https://showmarket-api.herokuapp.com/api/uploadImage/get-image/<?php echo $servis["img"]; ?>" alt="">
					</div>
				</div>
			</div>
